...
public class DisplayWindow extends Application {
    ...
    public void start(Stage stage) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/imageapex/show/resources/fxml/DisplayWindow.fxml"));
        Parent root = null;
        try {
        ...
        if (root != null) {
            ...
            stylesheets.addAll(this.getClass().getResource("/imageapex/show/resources/css/show.css").toExternalForm());
        }
        ...
        stage.show();
        System.out.println("Starting a new imageapex.show window...");
    }
